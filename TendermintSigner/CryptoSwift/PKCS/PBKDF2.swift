...
public extension PKCS5 {
    ...
    struct PBKDF2 {
        ...
        public init(password: Array<UInt8>, salt: Array<UInt8>, iterations: Int = 4096 /* c */, keyLength: Int? = nil /* dkLen */, variant: HMAC_CC.Variant = .sha256) throws {
            precondition(iterations > 0)

            let prf = HMAC_CC(key: password, variant: variant)
